...
files_e<-list.files(path = '/home/jdp/MEGA/CONAE/Olas de calor/con_minimas',
                    pattern = ".nc",
                    full.names = TRUE,
                    ignore.case = TRUE)
files_e
...
getwd()
setwd("/home/jdp/MEGA/CONAE/Olas de calor/con_minimas")
...
p90_arg <- mask(p90_om_c, mascara, filename="p90_min_arg_mask.tif", inverse=FALSE, updatevalue=NA, updateNA=FALSE)
writeRaster(p90_om_c, "p90_min_arg.tiff",format="GTiff")
