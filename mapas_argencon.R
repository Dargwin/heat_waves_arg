...
figure3a<-tm_shape(y2015_hw_mask)+
  tm_raster(palette=paleta,
...
figure3b<-tm_shape(gg30_y2015_hw_mask)+
  tm_raster(palette=paleta,
            title="heat-waves (n° events)")+
...
tmap_save(
  tm = figure3,
  filename = "/home/julius/figuras/figure_3.svg",
  units = "cm",
  width = 10,
  height = 5,
  dpi = 600,
...
write.table(df_hw_by_dpto, "table1_heatcount_by_dpto2.txt", sep = ";", na = "0")
